...
@section('content')
  <form method="POST" action="{{ route('register.action') }}" class="rounded-lg bg-white p-5 w-[90vw] shadow-md">
    @csrf
    <div class="mb-5">
    ...
    <small class="block text-center mt-3">sudah punya akun? <a href="{{ route('login') }}"
        class="text-primary font-semibold">Login</a></small>
  </form>
@endsection
